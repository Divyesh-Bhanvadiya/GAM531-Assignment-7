...
namespace OpenTK_Sprite_Animation
{
    ...
    public class SpriteAnimationGame : GameWindow
    {
        ...
        public float frameW = 128f;
        public float frameH = 126f;
        ...
        protected override void OnLoad()
        {
            ...
            _texture = LoadTexture("My_Shinobi_Spritelist.png"); // Upload sprite sheet

            // Quad vertices: [pos.x, pos.y, uv.x, uv.y], centered model space
            float w = frameW/2, h = frameH/2;                   // Half-size: results in 64x128 sprite
            float[] vertices =
            {
                -w, -h, 0f, 0f,
                 w, -h, 1f, 0f,
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            _character.Update((float)e.Time, KeyboardState);
        }
